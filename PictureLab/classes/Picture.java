...
public class Picture extends SimplePicture 
{
    ...
    public void colorRed()
    {
        ...
        {
            //pixels[row][120].setColor(new Color(pixels[row][120].getRed() + 25, 0, 0));
            //pixels[row][121].setColor(new Color(pixels[row][120].getRed() + 25, 0, 0));
            //pixels[row][122].setColor(new Color(pixels[row][120].getRed() + 25, 0, 0));
            //pixels[row][123].setColor(new Color(pixels[row][120].getRed() + 25, 0, 0));
            //pixels[row][124].setColor(new Color(pixels[row][120].getRed() + 25, 0, 0));
            //pixels[row][125].setColor(new Color(pixels[row][120].getRed() + 25, 0, 0));
            for(int i = 120; i < 180; i++)
            {
                pixels[row][i].setColor(new Color(pixels[row][i].getRed() + 25, 0, 0));
            }
...
//     }
    ...
    public void createCollage(String picture)
    {
        ...
        //Picture pic1 = new Picture("bb8.jpg");
        //Picture bb8 = new Picture(pic);
        //Picture bb81 = new Picture(pic1);
        //bb8.copy(pic,600, 600);
        //bb81.copy(pic1,0,0);
        ...
        //this.colorRed();
        //    this.copy(KylorenNoBlue,300,0);
        //    this.copy(flower1,400,0);
        this.copy(pic1,0,0);
        this.copy(pic2,0,600);
        this.copy(pic3,600,0);
        this.copy(pic4,600,600);      
    ...
    {
        Picture beach = new Picture("starwars.jpg");
        beach.explore();
        //beach.zeroBlue();
        beach.explore();
    }
